...
## dos_dup
コマンドライン引数で指定したファイルハンドルを`DOS _DUP`で複写し、結果を表示します。


## dos_dup0
`DOS _DUP0`でファイルハンドルを標準ファイルハンドルに強制複写し、結果を表示します。
コマンドライン引数でファイルハンドルと複写先のファイルハンドルを指定します。


## dos_dup2
`DOS _DUP2`でファイルハンドルを強制複写し、結果を表示します。
コマンドライン引数でファイルハンドルと複写先のファイルハンドルを指定します。
...
## dos_time_pr
`DOS _TIME_PR`でタイマのカウンタ値を取得し、結果を表示します。
